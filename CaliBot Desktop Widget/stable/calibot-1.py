...
class ChatWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.chat_box.setStyleSheet(
            "background-color: rgba(0, 0, 0, 0.25); border: 4px solid rgba(255, 255, 255, 0.2);color: white;"
        )
    ...
    def toggle_chatbox_size(self):
        ...
        if current_width == 400 and current_height == 300:
            self.setGeometry(self.x(), self.y(), 500, 500)
        elif current_width == 500 and current_height == 500:
            self.setGeometry(self.x(), self.y(), 50, 50)
        else:
            self.setGeometry(self.x(), self.y(), 400, 300)
